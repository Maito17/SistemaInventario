...
@login_required
@permission_required('finanzas.add_cuentaporcobrar', raise_exception=True)
...
@login_required
@permission_required('finanzas.view_cuentaporpagar', raise_exception=True)
...
def detalle_cuenta_por_pagar(request, pk):
    ...
    cuenta = get_object_or_404(CuentaPorPagar, pk=pk, owner=request.user)
...
@login_required
@permission_required('finanzas.add_amortizacionproveedor', raise_exception=True)
...
@login_required
@permission_required('finanzas.view_cuentaporcobrar', raise_exception=True)
def lista_cuentas_por_cobrar(request):
    ...
    cuentas = CuentaPorCobrar.objects.select_related('venta__cliente', 'cliente').filter(owner=request.user)
...
def detalle_cuenta_por_cobrar(request, pk):
    ...
    cuenta = get_object_or_404(CuentaPorCobrar, pk=pk, owner=request.user)
...
@login_required
@permission_required('finanzas.add_amortizacioncliente', raise_exception=True)
...
@login_required
@permission_required('finanzas.add_solicitudcredito', raise_exception=True)
...
@login_required
@permission_required('finanzas.view_solicitudcredito', raise_exception=True)
def lista_solicitudes_credito(request):
    ...
    if query:
        solicitudes = solicitudes.filter(
            Q(cliente__nombre__icontains=query) |
            Q(cliente__apellido__icontains=query) |
            Q(cliente__ruc_cedula__icontains=query) |
...
def detalle_solicitud_credito(request, pk):
    ...
    solicitud = get_object_or_404(SolicitudCredito, pk=pk, owner=request.user)
...
@login_required
@permission_required('finanzas.change_solicitudcredito', raise_exception=True)
...
@login_required
@permission_required('finanzas.view_amortizacionproveedor', raise_exception=True)
...
@login_required
@permission_required('finanzas.view_amortizacioncliente', raise_exception=True)
