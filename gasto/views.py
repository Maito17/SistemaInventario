...
@login_required
@permission_required('gasto.view_gasto', raise_exception=True)
...
@login_required
@permission_required('gasto.add_gasto', raise_exception=True)
...
@login_required
@permission_required('gasto.change_gasto', raise_exception=True)
...
@login_required
@permission_required('gasto.delete_gasto', raise_exception=True)
...
@login_required
@permission_required('gasto.view_detallegastoadministracion', raise_exception=True)
...
@login_required
@permission_required('gasto.view_detallegastoventa', raise_exception=True)
...
@login_required
@permission_required('gasto.view_tipogasto', raise_exception=True)
