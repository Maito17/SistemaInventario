...
# Database
# Default configuration (MySQL values by env)
...
# Allow DATABASE_URL override (Railway)
try:
    import dj_database_url
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'jd15325@gmail.com')
...
# Optional: configure gemini client only if key provided
