...
# Token de recuperación de contraseña almacenado en BD (ver usuarios.models.PasswordResetToken)
...
def crear_usuario(request):
    ...
    # Verificación de límite deshabilitada
    # if not verificar_limite_usuarios(request.user):
    #     messages.error(request, "Has alcanzado el límite de usuarios.")
...
def password_reset_request(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            logging.getLogger(__name__).error('Error en password_reset_request: %s', traceback.format_exc())
