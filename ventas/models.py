...
class Venta(models.Model):
    ...
    # Estado de la venta (Activa / Anulada)
    estado = models.CharField(max_length=5, choices=ESTADO_VENTA, default='ACT', verbose_name="Estado")
    subido_sri_manual = models.BooleanField(default=False, verbose_name="Subido manualmente al SRI")
    anulado_por = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='ventas_anuladas', verbose_name="Anulado por")
